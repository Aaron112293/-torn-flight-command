...
// @updateURL    https://raw.githubusercontent.com/Aaron112293/-torn-flight-command/main/Torn_Flight_Command_v1.8.50_BOTTOM_TAB_TEST.user.js
// @downloadURL  https://raw.githubusercontent.com/Aaron112293/-torn-flight-command/main/Torn_Flight_Command_v1.8.50_BOTTOM_TAB_TEST.user.js
...
(function () {
    ...
    const VERSION = 'v1.8.50 BOTTOM TAB TEST';
    ...
    function installStyles() {
        ...
        style.textContent = `
            #fc-panel {
                ...
                overflow: hidden;
                box-shadow: 0 -12px 42px rgba(0,0,0,.68);
                color: #eee;
            ...
            #fc-bottom-tab {
                ...
                background: linear-gradient(180deg, #355f88, #223f5d);
                box-shadow: 0 -3px 12px rgba(0,0,0,.42);
                color: #f4f8fc;
                font: 900 14px -apple-system, BlinkMacSystemFont, "Segoe UI", Arial, sans-serif;
                letter-spacing: .7px;
                text-align: center;
            }

            #fc-bottom-tab.active {
                background: linear-gradient(180deg, #447caf, #2b5277);
                color: #fff;
            }
    ...
    function openPanel() {
        ...
        const bottomTab = document.getElementById('fc-bottom-tab');
        bottomTab?.classList.add('active');
        bottomTab?.setAttribute('aria-expanded', 'true');
    ...
    function closePanel() {
        ...
        const bottomTab = document.getElementById('fc-bottom-tab');
        bottomTab?.classList.remove('active');
        bottomTab?.setAttribute('aria-expanded', 'false');
    }
    ...
    function createBottomTab() {
        if (!document.body || document.getElementById('fc-bottom-tab')) return;
        installStyles();
        const button = document.createElement('button');
        button.id = 'fc-bottom-tab';
        button.type = 'button';
        button.textContent = '✈ FLIGHT COMMAND';
        button.setAttribute('aria-label', 'Open Flight Command');
