// ==UserScript==
// @name         Flight Command Prototype V1.0
...
(function () {
    ...
    const VERSION = 'v1.8.58 PROTOTYPE V1';
    const DISPLAY_LABEL = 'FLIGHT COMMAND PROTOTYPE V1.0';
    ...
    const ADMIN_PASSWORD_HASH_KEY = 'fc-admin-password-hash-v1';
    ...
    function installStyles() {
        ...
        style.textContent = `
            ...
            #fc-toolbar-launcher.fc-standalone-launcher {
                position: fixed;
                right: 10px;
    ...
    function bindAdminControls() {
        ...
        document.getElementById('fc-save-admin-password')?.addEventListener('click', async () => {
    ...
    function installSeparateFlightButton(allowStandaloneFallback = false) {
        ...
        const existing = document.getElementById('fc-toolbar-launcher');
        const replaceFallback = existing?.classList.contains('fc-standalone-launcher') && notesControl?.parentElement;
        ...
        if (!notesControl?.parentElement) {
            ...
            launcher.className = 'fc-standalone-launcher';
