...
// @updateURL    https://raw.githubusercontent.com/Aaron112293/-torn-flight-command/main/Torn_Flight_Command_v1.8.25.user.js
// @downloadURL  https://raw.githubusercontent.com/Aaron112293/-torn-flight-command/main/Torn_Flight_Command_v1.8.25.user.js
...
(function () {
    ...
    function bindFlightControl() {
        ...
        document.getElementById('fc-autopilot-switch')?.addEventListener('change', event => {
            autopilotEnabled = Boolean(event.target.checked);
