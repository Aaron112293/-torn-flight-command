...
// @updateURL    https://raw.githubusercontent.com/Aaron112293/-torn-flight-command/main/Torn_Flight_Command_v1.8.28.user.js
// @downloadURL  https://raw.githubusercontent.com/Aaron112293/-torn-flight-command/main/Torn_Flight_Command_v1.8.28.user.js
    ...
    function syncPurchaseControl() {
        ...
        if (button) {
            ...
            if (smartPurchaseBusy) {
                ...
                button.textContent = `AUTO BUY IN ${purchaseWait}s`;
