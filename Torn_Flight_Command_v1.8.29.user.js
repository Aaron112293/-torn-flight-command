...
// @updateURL    https://raw.githubusercontent.com/Aaron112293/-torn-flight-command/main/Torn_Flight_Command_v1.8.29.user.js
// @downloadURL  https://raw.githubusercontent.com/Aaron112293/-torn-flight-command/main/Torn_Flight_Command_v1.8.29.user.js
...
(function () {
    ...
    function createPanel() {
        ...
        panel.innerHTML = `
            ...
            <div id="fc-tabs">
                ...
                <button id="fc-report-tab" type="button">OVERALL FLIGHTS SUMMARY</button>
            ...
            <div id="fc-report-panel" style="display:none;">
                <div id="fc-report-header">
                    <div id="fc-report-title">OVERALL FLIGHTS SUMMARY</div>
                </div>
    ...
    function renderTornReport() {
        ...
        if (!content) return;
        const active = loadActiveTripSummary();
        ...
        content.innerHTML = `
            <div class="fc-report-stats">
                <div class="fc-report-stat"><div class="fc-report-stat-label">Completed trips</div><div class="fc-report-stat-value">${lifetime.flights.toLocaleString('en-US')}</div></div>
                <div class="fc-report-stat"><div class="fc-report-stat-label">Items purchased</div><div class="fc-report-stat-value">${lifetime.items.toLocaleString('en-US')}</div></div>
