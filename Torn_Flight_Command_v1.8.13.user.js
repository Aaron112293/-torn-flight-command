...
// @version      1.8.13
// @description  Flight Command Mexico cards plus tap, hold, destination, and flight-type controls
// @updateURL    https://raw.githubusercontent.com/Aaron112293/-torn-flight-command/main/Torn_Flight_Command_v1.8.13.user.js
// @downloadURL  https://raw.githubusercontent.com/Aaron112293/-torn-flight-command/main/Torn_Flight_Command_v1.8.13.user.js
...
(function () {
    ...
    const FLIGHT_INTENT_KEY = 'fc-pending-flight-intent-v1';
    ...
    function flightTypePattern(type) {
        if (type === 'Private Jet') return /\bprivate\s+(?:jet|flight)\b|\bjet\b/i;
        ...
        try {
            ...
            if (!flightTypeControl) {
                ...
                flightTypeControl = await waitForValue(() => {
                    ...
                    return findFlightTypeControl(dialog || document.body, intent.flightType);
                }, 3500);
            }
    ...
    function updatePanel() {
        ...
        if (!country || !route || !mode || !hint) return;
