...
// @updateURL    https://raw.githubusercontent.com/Aaron112293/-torn-flight-command/main/Torn_Flight_Command_v1.8.15.user.js
// @downloadURL  https://raw.githubusercontent.com/Aaron112293/-torn-flight-command/main/Torn_Flight_Command_v1.8.15.user.js
...
(function () {
    ...
    async function processPendingFlightIntent() {
        ...
        try {
            ...
            if (existingContinue) {
                existingContinue.click();
                recordFlightAction('FINAL_CONFIRMATION_CLICKED', null, {
                    intent,
                    control: controlSnapshot(existingContinue),
                    travelTypeValue: travelTypeRadio.value,
            ...
            if (!flightTypeControl) {
                ...
                if (continueControl) {
                    ...
                    recordFlightAction('FINAL_CONFIRMATION_CLICKED', null, {
                        intent,
                        control: controlSnapshot(continueControl),
                        travelTypeValue: travelTypeRadio.value
                    });
                    clearPendingFlightIntent();
                    return;
