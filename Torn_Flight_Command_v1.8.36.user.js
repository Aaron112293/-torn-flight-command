...
// @updateURL    https://raw.githubusercontent.com/Aaron112293/-torn-flight-command/main/Torn_Flight_Command_v1.8.36.user.js
// @downloadURL  https://raw.githubusercontent.com/Aaron112293/-torn-flight-command/main/Torn_Flight_Command_v1.8.36.user.js
...
(function () {
    ...
    function ownTravelIndicatorIsVisible() {
        ...
        // Torn's actual in-flight page marks the player's own content wrapper.
        // Other players' travel statuses on faction/profile pages do not.
        return [...document.querySelectorAll('[class~="travelling"], [class~="traveling"]')]
            .some(element => visibleElement(element) && !element.closest('#fc-panel'));
    }
    ...
    function getFlightInfo() {
        ...
        const flightPageText = [...document.querySelectorAll(
